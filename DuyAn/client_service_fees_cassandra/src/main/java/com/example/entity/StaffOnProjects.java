...
public class StaffOnProjects implements java.io.Serializable {
	...
	public Integer getStaff_on_project_perioc_id() {
		return staff_on_project_perioc_id;
	}

	public void setStaff_on_project_perioc_id(Integer staff_on_project_perioc_id) {
		this.staff_on_project_perioc_id = staff_on_project_perioc_id;
	}
